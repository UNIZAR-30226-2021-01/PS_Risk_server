/*
	El paquete server proporciona tipos de datos y funciones para controlar los
	tokens de recuperación de contraseña y para atender a todas las peticiones
...
func NuevoServidor(p, bbdd, smtpServer, smtpPort, mail, mailPass string) (*Servidor, error) {
	...
	return &Servidor{
		...
		Partidas:    sync.Map{},
		Restablecer: ttlMap.CrearTTLmap(10)}, nil
}
